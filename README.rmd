...
A reference to a paper describing this method will be added once published. A vignette for this package is also available and can be viewed by typing `browseVignettes("concordance")` in R (after installation). 
